...
class Villas extends AdminBase
{
    public function _config(){
        ...
        $this->add_form = [
            ...
            // ['type'=>'text','title'=>'原价','field'=>'villas_original_price'],
            // ['type'=>'text','title'=>'现价','field'=>'villas_price'],
            ...
            ['type'=>'image-multiple','title'=>'图集','field'=>'villas_gallery'],
            ['type'=>'text','title'=>'权重','field'=>'villas_sort'],
            // ['type'=>'image','title'=>'详情底图','field'=>'villas_detail_banner_img'],
            ...
            // ['type'=>'textarea','title'=>'地区简述','field'=>'villas_location_desc'],
    ...
    {
        $data['villas_selling_point'] = implode(',', $data['villas_selling_point']);
        $data['villas_hardware']      = implode(',', $data['villas_hardware']);
        $data['villas_tag']           = implode(',', $data['villas_tag']);
        return $data;
    }
